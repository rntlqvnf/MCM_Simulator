  ...
  , _enabled(true)
{
  ...
  _labeloff->setAlignment(Qt::AlignCenter);
  _labelon->setAlignment(Qt::AlignCenter);
  _labeloff->setText("Stop");
  _labelon->setText("Play");
  _labeloff->move(45, 4);
  _labelon->move(20, 4);
  setFixedSize(QSize(150, 24));
